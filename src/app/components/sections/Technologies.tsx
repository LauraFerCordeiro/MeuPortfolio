...
export default function Technologies() {
  ...
  // "Todas" has 20 items → use smaller cards; other categories use normal cards
    ...
    <section className="w-full min-h-screen md:h-screen flex items-start md:items-center justify-center px-4 md:px-6 py-8 md:py-0 relative" style={{ overflow: 'hidden', maxWidth: '100vw' }}>
      ...
      <div className="hidden md:flex flex-col w-full max-w-7xl relative z-10 h-screen py-6">
        ...
        {/*
          ...
          - flex-1 + min-h-0 makes it fill the remaining vertical space without pushing header.
          - overflow-x-hidden kills any horizontal scrollbar from the grid spilling outside.
        */}
              ...
              {filteredTechs.map((tech, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`
                        relative h-full bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-xl rounded-2xl
                    ...
                    >
                      ...
                      >
                        <Icon
                          className={isAll ? 'w-10 h-10' : 'w-12 h-12'}
        ...
        {/* Bottom spacer so the page arrow has clearance */}
      ...
      <style>{`
        ...
        /* Thin visible scrollbar for the Todas grid */
        ...
        /* Prevent any horizontal scrollbar flash at document level */
